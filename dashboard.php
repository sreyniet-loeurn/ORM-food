...
<div class="container">
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/restaurant/<?php echo $row['fld_email']."/foodimages/" .$row['fldimage'];?>" height="70px" width="100px">
						<br><br><?php echo $row['foodname'];?>
						</td>
...
<!--tab 1 ends-->	   
	...
	?>			 
                    ...
                    <tr>
                        ...
                        <th scope="row"><?php echo $row['fldvendor_id'];?></th>
						<td><img src="image/restaurant/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="70px" width="100px"></td>
						<td><?php echo $row['fld_name'];?></td>
