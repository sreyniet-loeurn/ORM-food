<footer class="flex-rw">
	...
	<ul class="footer-list-top">
		<li>
			<h4 class="footer-list-header textstyle">About Pavilion</h4>
		</li>
		<li><a href='/promos.html' class="generic-anchor textstyle" itemprop="significantLink">PROMOS</a></li>
		<li><a href='/retailers/new-retailers.html' class="generic-anchor textstyle" itemprop="significantLink">BECOME A RETAILER</a></li>

		<li><a href='/job-openings.html' itemprop="significantLink" class="generic-anchor textstyle">JOB OPENINGS</a></li>

		<li><a href='/shop/about-show-schedule' class="generic-anchor textstyle" itemprop="significantLink">EVENTS</a></li>
	</ul>
	<ul class="footer-list-top">
		<li>
			<h4 class="footer-list-header textstyle">The Gift Selection</h4>
		</li>


		<li><a href='/Home-Decor/cat/id/64' class="generic-anchor textstyle">HOME DECOR</a></li>
		<li><a href='/Mugs/cat/id/32' class="generic-anchor textstyle">MUGS</a></li>
		<li><a href='/Pet-Lover/cat/id/108' class="generic-anchor textstyle">PET LOVER</a></li>
		<li><a href='/Ladies-Accessories/cat/id/117' class="generic-anchor textstyle" target="_blank">HANDBAGS & JEWELRY</a></li>
	</ul>
	<ul class="footer-list-top">
		<li id='help'>
			<h4 class="footer-list-header textstyle">Please Help Me</h4>
		</li>
		<li><a href='/faq.html' class="generic-anchor textstyle" itemprop="significantLink">FAQ</a></li>
		<li id='find-a-store'><a href='/shop/store-locator' class="generic-anchor textstyle" itemprop="significantLink">STORE LOCATOR</a></li>
		<li id='user-registration'><a href='/shop/user-registration?URL=' class="generic-anchor textstyle" itemprop="significantLink">NEW USERS</a></li>
